...
function authorize(data) {
    ...
    let auth_location = `${authEndpoint}?` +
        ...
        `launch=${launchId}&` +
        "scope=patient%2FPatient.read%20patient%2FCondition.read%20patient%2FObservation.read%20launch%20fhirUser&" + //if we specify scopes that are not registered for our app, we get an invalid_grant error
